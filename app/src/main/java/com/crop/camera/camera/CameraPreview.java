package com.crop.camera.camera;
        ...
        if (camera != null) {
            try {
                ...
                if (getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT) {
                    ...
                    rotatePreview = 90;
//                   Log.i("cameraPreview surfaceCreated ", "PORTRAIT setRotation 90");
                } else {
                    camera.setDisplayOrientation(0);
                    parameters.setRotation(0);
                    rotatePreview = 0;
//                   Log.i("cameraPreview surfaceCreated ", "PORTRAIT setRotation 0");
                }
